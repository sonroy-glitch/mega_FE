        ...
        <div className="relative z-10 flex h-full items-center px-10 md:px-16">
          <div className="max-w-2xl text-white">
            ...
            <div className="mt-8">
              ...
              <div className="rounded-md px-6  py-3 text-sm font-semibold text-white transition hover:bg-slate-400 hover:text-black" >
                A technical driven student community that builds competitive robots and tackles real-world challenges while actively participating in national and international tech events. 
              </div>
            </div>
          </div>
        </div>
